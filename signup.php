            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" method="POST" action="new.php">
                            ...
                            <div class="form-group">
                                <label for="re-pass"><i class="zmdi zmdi-lock-contact"></i></label>
                                <input type="number" name="re_pass" id="re_pass" placeholder="Contact Number"/>
                            </div>
                            <div class="form-group">
